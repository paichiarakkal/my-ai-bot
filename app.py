...
<style>
    ...
    .profile-name { color: #000; font-size: 22px; font-weight: bold; margin-top: 10px; text-align: center; }
...
st_autorefresh(interval=15000, key="faisal_ultimate_fixed_v22")
