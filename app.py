...
st_autorefresh(interval=15000, key="faisal_final_no_graph_v3")
...
if mode == "MARKET":
    ...
    if data:
        ...
        st.session_state.last_price = lp # ജേണലിലേക്ക് വില സ്റ്റോർ ചെയ്യുന്നു
    ...
    with st.expander("പുതിയ ട്രേഡ് ചേർക്കുക", expanded=True):
        ...
        # ലൈവ് വില ഓട്ടോമാറ്റിക് ആയി വരുന്നു
